...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeyMetrics'
        db.create_table(u'technologies_keymetrics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('technology', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['technologies.Technology'])),
            ('metric_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'technologies', ['KeyMetrics'])


    def backwards(self, orm):
        # Deleting model 'KeyMetrics'
        db.delete_table(u'technologies_keymetrics')
    ...
    models = {
        ...
        u'technologies.keymetrics': {
            'Meta': {'object_name': 'KeyMetrics'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metric_description': ('django.db.models.fields.TextField', [], {}),
